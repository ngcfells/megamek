 ...
 */
public abstract class StreakSRTWeapon extends SRTWeapon {
    @Serial
    private static final long serialVersionUID = -551008288820260008L;

    public StreakSRTWeapon() {
        super();
        this.ammoType = AmmoType.AmmoTypeEnum.SRM_STREAK_TORPEDO;
    ...
    public String getSortingName() {
        ...
        return "SRT Streak " + oneShotTag + rackSize;
    }
}
