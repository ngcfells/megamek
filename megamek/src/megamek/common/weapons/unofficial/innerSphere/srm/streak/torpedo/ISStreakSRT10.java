 ...
 */
public class ISStreakSRT10 extends SRTWeapon {
    @Serial
    private static final long serialVersionUID = -551008288820260006L;

    public ISStreakSRT10() {
        super();
        this.name = "Streak SRT 10";
        this.setInternalName(this.name);
        this.addLookupName("IS Streak SRT-10");
        this.addLookupName("ISStreakSRT10");
        this.addLookupName("IS Streak SRT 10");
        this.addLookupName("IS Streak SRT10");
        this.heat = 6;
        this.rackSize = 10;
        this.shortRange = 3;
        this.mediumRange = 6;
