 ...
 */
public class ISSRM8IOS extends SRMWeapon {
    @Serial
    private static final long serialVersionUID = -1740678714097126805L;

    public ISSRM8IOS() {
        super();
        name = "SRM 8 (I-OS)";
        setInternalName("ISSRM8IOS");
        // addLookupNames below for mtf, tdb, and mep
        addLookupName("ISSRM8 (IOS)");
        addLookupName("IS SRM 8 (IOS)");
        addLookupName("IOS SRM-8");
        heat = 5;
        rackSize = 8;
        shortRange = 3;
        mediumRange = 6;
