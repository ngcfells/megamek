 ...
 */
public class ISSRM10 extends SRMWeapon {
    @Serial
    private static final long serialVersionUID = -551008288820260003L;

    public ISSRM10() {
        super();
        this.name = "SRM 10";
        this.setInternalName(this.name);
        this.addLookupName("IS SRM-10");
        this.addLookupName("ISSRM10");
        this.addLookupName("IS SRM 10");
        this.addLookupName("IS SRM10");
        this.heat = 6;
        this.rackSize = 10;
        this.shortRange = 3;
        this.mediumRange = 6;
