 ...
 */
public class ISSRM10IOS extends SRMWeapon {
    @Serial
    private static final long serialVersionUID = -8658614541900440112L;

    public ISSRM10IOS() {
        super();
        name = "SRM 10 (I-OS)";
        setInternalName("ISSRM10IOS");
        addLookupName("ISSRM10 (IOS)"); // mtf
        addLookupName("IS SRM 10 (IOS)"); // tdb
        addLookupName("IOS SRM-10"); // mep
        heat = 6;
        rackSize = 10;
        shortRange = 3;
        mediumRange = 6;
