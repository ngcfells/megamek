 ...
 */
public class ISSRT10 extends SRTWeapon {
    @Serial
    private static final long serialVersionUID = 5605930999660077504L;

    public ISSRT10() {
        super();
        this.name = "SRT 10";
        this.setInternalName(this.name);
        this.addLookupName("IS SRT-10");
        this.addLookupName("ISSRT10");
        this.addLookupName("IS SRT 10");
        this.addLookupName("IS SRT10");
        this.heat = 6;
        this.rackSize = 10;
        this.shortRange = 3;
        this.mediumRange = 6;
