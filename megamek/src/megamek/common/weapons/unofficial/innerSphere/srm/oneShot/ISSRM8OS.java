 ...
 */
public class ISSRM8OS extends SRMWeapon {

    @Serial
    private static final long serialVersionUID = 5997308357526672882L;

    public ISSRM8OS() {
        super();
        name = "SRM 8 (OS)";
        setInternalName("ISSRM8OS");
        // addLookupNames below for mtf, tdb, and mep
        addLookupName("ISSRM8 (OS)");
        addLookupName("IS SRM 8 (OS)");
        addLookupName("OS SRM-8");
        heat = 5;
        rackSize = 8;
        shortRange = 3;
        mediumRange = 6;
